...
class PopupMenu(object):
    def __init__(self, parent):
        ...
        self.parent = parent
        self.width = self.parent.getWidth() / 2
        self.height = self.parent.getHeight() / 2
        self.area = parent.subsurface((self.parent.getWidth() / 4), (self.parent.getHeight() / 4), self.width, self.height)
    ...
    def loadButtons(self):
        ...
        self.resolvebutton.newButton(self.area.getWidth() / 2 - 80, self.area.getHeight() / 2 + 5, 5)
        self.resolvebutton.newButton(self.area.getWidth() / 2 - 80, self.area.getHeight() / 2 + 25, 5)
        self.resolvebutton.newButton(self.area.getWidth() / 2 - 80, self.area.getHeight() / 2 + 45, 5)
        self.resolvebutton.newButton(self.area.getWidth() / 2 + 20, self.area.getHeight() / 2 + 5, 5)
    ...
    def makePopupMenu(self):
        ...
        self.area.blit(self.textOptions, (self.area.getWidth()/2 - (0.5 * self.textoptions.getWidth()), 5))
        self.resumebutton = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2 - 80, 200, 30), "Resume Game", (94, 0, 9), (190, 192, 194))
        self.savebutton = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2 - 40, 200, 30), "Save Game", (94, 0, 9), (190, 192, 194))
        self.gameoptionsbutton = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2, 200, 30), "Game Options", (94, 0, 9), (190, 192, 194))
        self.exitbutton = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2 + 40, 200, 30), "Exit Game", (94, 0, 9), (190, 192, 194))
    ...
    def gameOptions(self):
        ...
        # back button
        self.exitbutton = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2 - 80, 200, 30), "Back", (94, 0, 9), (190, 192, 194))

        # resolution options
        self.loadButtons()
        self.textresolution = pygame.font.Font(os.path.join("font","berlin.ttf"), 20).render("Resolution Options", True, (94, 0, 9))
        self.area.blit(self.textresolution, (self.area.getWidth() / 2 - (0.5 * self.textresolution.getWidth()), self.area.getHeight() / 2 - 30))
        ...
        self.area.blit(self.resoultiontext1, (self.area.getWidth() / 2 - 70, self.area.getHeight() / 2))
        self.area.blit(self.resoultiontext2, (self.area.getWidth() / 2 - 70, self.area.getHeight() / 2 + 20))
        self.area.blit(self.resoultiontext3, (self.area.getWidth() / 2 - 70, self.area.getHeight() / 2 + 40))
        self.area.blit(self.resoultiontext4, (self.area.getWidth() / 2 + 30, self.area.getHeight() / 2))
    ...
    def exit_check(self):
        ...
        self.exitbuttonyes = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2 - 60, 200, 30), "Yes", (94, 0, 9), (190, 192, 194))
        self.exitbuttonno = Button(self.area, pygame.Rect(self.area.getWidth() / 2 - 100, self.area.getHeight() / 2 - 20, 200, 30), "No", (94, 0, 9), (190, 192, 194))
