...
class Game(object):
    ...
    def menu(self):
        ...
        text_start = font_op(32,"berlin").render("Start Game",True,(255,255,255))
        text_start_bg = font_op(32,"berlin").render("Start Game",True,(0,0,0))
        ...
        while menu:
                ...
                if event.type == MOUSEMOTION:  #Highlight text on hover
                    ...
                    if mouseX > self.screen.get_width()/2-107\
                       ...
                       and mouseY > 195 and mouseY < 200+text_start.get_height():
                        ...
                        text_start = font_op(32,"berlin").render("Start Game",True,(220,146,40))  
                        if mouseX > self.screen.get_width()/2-107\
            ...
            if rulesActive == True:
                ...
                self.screen.blit(self.img_menu_bg, (0, 0))
                self.screen.blit(text_header_bg,(self.screen.get_width()/2-3-0.5*text_header_bg.get_width()+4,20))
                self.screen.blit(text_header,(self.screen.get_width()/2-3-0.5*text_header.get_width(),16))
